...
<div>
  <Tabbar>
    ...
    <TablebarItem path="myCart" activeColor="red">
    ...
    <TablebarItem path="profile" activeColor="red">
...
<script>
  ...
  import TablebarItem from "components/common/tabbar/TablebarItem";
